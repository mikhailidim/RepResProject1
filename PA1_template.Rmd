...
```
Dayly based statistics gives us __`r summary(stepsbyday$steps)[4]`__ as average amount of steps  with median equal to  __`r summary(stepsbyday$steps)[3]`__. Othere summary facts are below:
```{r}
